        ...
        body: SafeArea(
          child: Column(
            ...
            children: <Widget>[
              ...
              Text(
                'I have completed my schooling from shri gulab rai montessori sr.sec.school, bareilly,'
                ' Uttar Pradesh with aggregate percentage of 96% in 12th '
                'standard & 94% in 10th standard.',
                style: TextStyle(
                    fontFamily: 'Roboto',
                    fontSize: 20,
                    color: Colors.purple,
